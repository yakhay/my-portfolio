...
const Projects = forwardRef((props, ref) => {
  ...
  return (
    <div ref={ref}  className='flex justify-center items-center flex-col p-[70px] '>

        <div >
            <h1 className='text-[48px] mb-[20px] text-center'>Projects</h1>
        </div>
        
            <div data-aos="fade-right" className='grid grid-cols-1 lg:grid-cols-2 gap-24 w-[80%] items-center'>
                <div className=''>
                ...
                <div data-aos="fade-right" className=''>
                    ...
                    <div className='flex justify-center items-center flex-col '>
                        <a target="_blank" rel="noopener noreferrer" className=' flex justify-center items-center w-[150px] h-[50px] border-2 border-[#0FE1C2] rounded-lg mt-[20px] hover:bg-[#0FE1C2]' href="https://food-eta-rose.vercel.app/"> View code</a>
                    </div>
